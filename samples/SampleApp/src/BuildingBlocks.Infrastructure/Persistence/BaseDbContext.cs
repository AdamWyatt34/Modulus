...
using SampleApp.BuildingBlocks.Infrastructure.Inbox;
using SampleApp.BuildingBlocks.Infrastructure.Outbox;

namespace SampleApp.BuildingBlocks.Infrastructure.Persistence;
