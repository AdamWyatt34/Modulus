...
namespace SampleApp.Notifications.Tests.Architecture;

public class LayerDependencyTests
{
    private static readonly Assembly DomainAssembly = Notifications.Domain.AssemblyReference.Assembly;
    private static readonly Assembly ApplicationAssembly = Notifications.Application.AssemblyReference.Assembly;
    private static readonly Assembly InfrastructureAssembly = typeof(NotificationsDbContext).Assembly;
    private static readonly Assembly ApiAssembly = typeof(NotificationsEndpointRegistration).Assembly;

    private static readonly string RootNamespace = "SampleApp";
    private static readonly string ModuleName = "Notifications";
    ...
    /// <summary>
    /// Verifies that types in the given assembly do not depend on another module's
    /// Domain, Application, or Infrastructure layers. Only cross-module Integration
    ...
    private static void AssertNoCrossModuleDependencies(Assembly assembly)
    {
        ...
        foreach (var referenced in referencedAssemblies)
        {
            ...
            // Any other reference to a sibling module's internal layer is forbidden
            Assert.Fail(
