...
namespace SampleApp.Orders.Tests.Architecture;

public class LayerDependencyTests
{
    private static readonly Assembly DomainAssembly = Orders.Domain.AssemblyReference.Assembly;
    private static readonly Assembly ApplicationAssembly = Orders.Application.AssemblyReference.Assembly;
    private static readonly Assembly InfrastructureAssembly = typeof(OrdersDbContext).Assembly;
    private static readonly Assembly ApiAssembly = typeof(OrdersEndpointRegistration).Assembly;

    private static readonly string RootNamespace = "SampleApp";
    private static readonly string ModuleName = "Orders";
